package com.dnc.mprs.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dnc.mprs.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dnc.mprs.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
