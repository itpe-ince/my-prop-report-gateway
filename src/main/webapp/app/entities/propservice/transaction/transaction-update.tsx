...
export const TransactionUpdate = () => {
  ...
  const updating = useAppSelector(state => state.gateway.transaction.updating);
  const updateSuccess = useAppSelector(state => state.gateway.transaction.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.propserviceTransaction.home.createOrEditLabel" data-cy="TransactionCreateUpdateHeading">
            <Translate contentKey="gatewayApp.propserviceTransaction.home.createOrEditLabel">Create or edit a Transaction</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="transaction-id"
                  label={translate('gatewayApp.propserviceTransaction.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.propertyId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.transactionType')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.price')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.transactionDate')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.buyer')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.seller')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.agent')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.createdAt')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceTransaction.updatedAt')}
