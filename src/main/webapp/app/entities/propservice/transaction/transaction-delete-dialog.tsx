...
export const TransactionDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/transaction${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.propserviceTransaction.delete.question">
        <Translate contentKey="gatewayApp.propserviceTransaction.delete.question" interpolate={{ id: transactionEntity.id }}>
