...
import { ITransaction, defaultValue } from 'app/shared/model/propservice/transaction.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSACTION actions', async () => {
      const arg = 42666;
