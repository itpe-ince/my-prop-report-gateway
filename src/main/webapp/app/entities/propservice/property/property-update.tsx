...
export const PropertyUpdate = () => {
  ...
  const complexes = useAppSelector(state => state.gateway.complex.entities);
  ...
  const updating = useAppSelector(state => state.gateway.property.updating);
  const updateSuccess = useAppSelector(state => state.gateway.property.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.propserviceProperty.home.createOrEditLabel" data-cy="PropertyCreateUpdateHeading">
            <Translate contentKey="gatewayApp.propserviceProperty.home.createOrEditLabel">Create or edit a Property</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="property-id"
                  label={translate('gatewayApp.propserviceProperty.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.complexId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.address')}
                id="property-address"
                name="address"
                data-cy="address"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.regionCd')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.localName')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.street')}
                id="property-street"
                name="street"
                data-cy="street"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.floor')}
                id="property-floor"
                name="floor"
                data-cy="floor"
                type="text"
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.type')}
                id="property-type"
                name="type"
                data-cy="type"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.area')}
                id="property-area"
                name="area"
                data-cy="area"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.rooms')}
                id="property-rooms"
                name="rooms"
                data-cy="rooms"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.bathrooms')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.buildYear')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.parkingYn')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.description')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.createdAt')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.propserviceProperty.updatedAt')}
              ...
              <ValidatedField
                ...
                name="complex"
                data-cy="complex"
                label={translate('gatewayApp.propserviceProperty.complex')}
                type="select"
              >
                <option value="" key="0" />
                {complexes
