...
export const PropertyDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/property${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.propserviceProperty.delete.question">
        <Translate contentKey="gatewayApp.propserviceProperty.delete.question" interpolate={{ id: propertyEntity.id }}>
