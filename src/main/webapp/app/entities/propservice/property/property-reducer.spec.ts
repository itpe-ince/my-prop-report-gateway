...
import { IProperty, defaultValue } from 'app/shared/model/propservice/property.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './property.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROPERTY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROPERTY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROPERTY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROPERTY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROPERTY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROPERTY actions', async () => {
      const arg = 42666;
