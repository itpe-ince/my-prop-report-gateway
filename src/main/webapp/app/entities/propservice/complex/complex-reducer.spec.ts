...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './complex.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLEX_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPLEX actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPLEX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMPLEX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPLEX actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPLEX actions', async () => {
      const arg = 42666;
