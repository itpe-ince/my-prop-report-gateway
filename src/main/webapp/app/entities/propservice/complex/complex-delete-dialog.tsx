...
export const ComplexDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/complex${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.propserviceComplex.delete.question">
        <Translate contentKey="gatewayApp.propserviceComplex.delete.question" interpolate={{ id: complexEntity.id }}>
