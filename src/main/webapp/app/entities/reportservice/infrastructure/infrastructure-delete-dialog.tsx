...
export const InfrastructureDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/infrastructure${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.reportserviceInfrastructure.delete.question">
        <Translate contentKey="gatewayApp.reportserviceInfrastructure.delete.question" interpolate={{ id: infrastructureEntity.id }}>
