...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFRASTRUCTURE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INFRASTRUCTURE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INFRASTRUCTURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INFRASTRUCTURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INFRASTRUCTURE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INFRASTRUCTURE actions', async () => {
      const arg = 42666;
