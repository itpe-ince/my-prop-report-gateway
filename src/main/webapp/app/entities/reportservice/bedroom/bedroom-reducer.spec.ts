...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './bedroom.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEDROOM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEDROOM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEDROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEDROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEDROOM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEDROOM actions', async () => {
      const arg = 42666;
