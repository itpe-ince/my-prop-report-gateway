...
export const BedroomDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/bedroom${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.reportserviceBedroom.delete.question">
        <Translate contentKey="gatewayApp.reportserviceBedroom.delete.question" interpolate={{ id: bedroomEntity.id }}>
