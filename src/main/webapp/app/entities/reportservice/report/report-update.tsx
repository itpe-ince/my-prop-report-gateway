...
export const ReportUpdate = () => {
  ...
  const authors = useAppSelector(state => state.gateway.author.entities);
  ...
  const updating = useAppSelector(state => state.gateway.report.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.reportserviceReport.home.createOrEditLabel" data-cy="ReportCreateUpdateHeading">
            <Translate contentKey="gatewayApp.reportserviceReport.home.createOrEditLabel">Create or edit a Report</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="report-id"
                  label={translate('gatewayApp.reportserviceReport.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.reportTitle')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.reportDate')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.authorId')}
                id="report-authorId"
                name="authorId"
                data-cy="authorId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.summary')}
                id="report-summary"
                name="summary"
                data-cy="summary"
                type="text"
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.exteriorState')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.constructionYear')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.maintenanceState')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.parkingFacility')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.parkingCount')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.elevatorState')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.noiseState')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.homepadState')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.cctvYn')}
                id="report-cctvYn"
                name="cctvYn"
                data-cy="cctvYn"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.fireSafetyState')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.doorSecurityState')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.maintenanceFee')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.redevelopmentYn')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.rentalDemand')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.communityRules')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.complexId')}
                id="report-complexId"
                name="complexId"
                data-cy="complexId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.complexName')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.propertyId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.propertyName')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.createdAt')}
                id="report-createdAt"
                name="createdAt"
                data-cy="createdAt"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceReport.updatedAt')}
                id="report-updatedAt"
                name="updatedAt"
                data-cy="updatedAt"
                type="datetime-local"
              ...
              <ValidatedField
                ...
                name="author"
                data-cy="author"
                label={translate('gatewayApp.reportserviceReport.author')}
                type="select"
              >
                <option value="" key="0" />
                {authors
