...
import { IReport, defaultValue } from 'app/shared/model/reportservice/report.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches PARTIAL_UPDATE_REPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REPORT actions', async () => {
      const arg = 42666;
