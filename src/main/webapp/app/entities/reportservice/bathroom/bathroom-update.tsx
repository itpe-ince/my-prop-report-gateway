...
export const BathroomUpdate = () => {
  ...
  const updating = useAppSelector(state => state.gateway.bathroom.updating);
  ...
  const handleClose = () => {
    navigate(`/bathroom${location.search}`);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.reportserviceBathroom.home.createOrEditLabel" data-cy="BathroomCreateUpdateHeading">
            <Translate contentKey="gatewayApp.reportserviceBathroom.home.createOrEditLabel">Create or edit a Bathroom</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="bathroom-id"
                  label={translate('gatewayApp.reportserviceBathroom.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.reportId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.bathroomName')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.condtionLevel')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.bathroomSize')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.waterPressure')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.showerBoothPresence')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.bathtubPresence')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.floorAndCeiling')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceBathroom.remarks')}
                id="bathroom-remarks"
                name="remarks"
                data-cy="remarks"
                type="text"
              ...
              <ValidatedField
                ...
                name="report"
                data-cy="report"
                label={translate('gatewayApp.reportserviceBathroom.report')}
                type="select"
              >
                <option value="" key="0" />
                {reports
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/bathroom" replace color="info">
