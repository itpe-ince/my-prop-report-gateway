...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './bathroom.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATHROOM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BATHROOM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BATHROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BATHROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BATHROOM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BATHROOM actions', async () => {
      const arg = 42666;
