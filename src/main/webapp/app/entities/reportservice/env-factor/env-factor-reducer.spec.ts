...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENVFACTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENVFACTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENVFACTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENVFACTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENVFACTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENVFACTOR actions', async () => {
      const arg = 42666;
