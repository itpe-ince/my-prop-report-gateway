...
export const EnvFactorDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/env-factor${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.reportserviceEnvFactor.delete.question">
        <Translate contentKey="gatewayApp.reportserviceEnvFactor.delete.question" interpolate={{ id: envFactorEntity.id }}>
