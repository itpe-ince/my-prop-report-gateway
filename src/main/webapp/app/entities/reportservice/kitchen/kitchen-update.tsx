...
export const KitchenUpdate = () => {
  ...
  const updating = useAppSelector(state => state.gateway.kitchen.updating);
  const updateSuccess = useAppSelector(state => state.gateway.kitchen.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.reportserviceKitchen.home.createOrEditLabel" data-cy="KitchenCreateUpdateHeading">
            <Translate contentKey="gatewayApp.reportserviceKitchen.home.createOrEditLabel">Create or edit a Kitchen</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="kitchen-id"
                  label={translate('gatewayApp.reportserviceKitchen.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.reportId')}
                id="kitchen-reportId"
                name="reportId"
                data-cy="reportId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.kitchenName')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.conditionLevel')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.builtInCabinet')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.sinkCondition')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.ventilationSystem')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.applianceProvision')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceKitchen.remarks')}
                id="kitchen-remarks"
                name="remarks"
                data-cy="remarks"
                type="text"
              ...
              <ValidatedField
                ...
                name="report"
                data-cy="report"
                label={translate('gatewayApp.reportserviceKitchen.report')}
                type="select"
              >
                <option value="" key="0" />
                {reports
