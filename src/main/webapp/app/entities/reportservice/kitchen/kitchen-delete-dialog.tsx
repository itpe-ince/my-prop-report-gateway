...
export const KitchenDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/kitchen${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.reportserviceKitchen.delete.question">
        <Translate contentKey="gatewayApp.reportserviceKitchen.delete.question" interpolate={{ id: kitchenEntity.id }}>
