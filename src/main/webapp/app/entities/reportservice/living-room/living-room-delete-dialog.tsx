...
export const LivingRoomDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/living-room${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.reportserviceLivingRoom.delete.question">
        <Translate contentKey="gatewayApp.reportserviceLivingRoom.delete.question" interpolate={{ id: livingRoomEntity.id }}>
