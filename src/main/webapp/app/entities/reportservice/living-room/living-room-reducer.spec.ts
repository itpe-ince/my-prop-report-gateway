...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVINGROOM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIVINGROOM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIVINGROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LIVINGROOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LIVINGROOM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIVINGROOM actions', async () => {
      const arg = 42666;
