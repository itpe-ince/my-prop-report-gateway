...
export const EntranceUpdate = () => {
  ...
  const updating = useAppSelector(state => state.gateway.entrance.updating);
  const updateSuccess = useAppSelector(state => state.gateway.entrance.updateSuccess);
  const qualityStateTypeValues = Object.keys(QualityStateType);

  const handleClose = () => {
    navigate(`/entrance${location.search}`);
  };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.reportserviceEntrance.home.createOrEditLabel" data-cy="EntranceCreateUpdateHeading">
            <Translate contentKey="gatewayApp.reportserviceEntrance.home.createOrEditLabel">Create or edit a Entrance</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="entrance-id"
                  label={translate('gatewayApp.reportserviceEntrance.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('gatewayApp.reportserviceEntrance.reportId')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceEntrance.entranceName')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceEntrance.condtionLevel')}
              ...
              <ValidatedField
                label={translate('gatewayApp.reportserviceEntrance.entranceSize')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceEntrance.shoeRackSize')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceEntrance.pantryPresence')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.reportserviceEntrance.remarks')}
                id="entrance-remarks"
                name="remarks"
                data-cy="remarks"
                type="text"
              ...
              <ValidatedField
                ...
                name="report"
                data-cy="report"
                label={translate('gatewayApp.reportserviceEntrance.report')}
                type="select"
              >
                <option value="" key="0" />
                {reports
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/entrance" replace color="info">
