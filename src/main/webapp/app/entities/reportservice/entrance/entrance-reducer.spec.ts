...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './entrance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTRANCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTRANCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTRANCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENTRANCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTRANCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTRANCE actions', async () => {
      const arg = 42666;
