...
export const EntranceDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/entrance${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.reportserviceEntrance.delete.question">
        <Translate contentKey="gatewayApp.reportserviceEntrance.delete.question" interpolate={{ id: entranceEntity.id }}>
