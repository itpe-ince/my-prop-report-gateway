...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTISENDJOB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTISENDJOB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTISENDJOB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTISENDJOB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTISENDJOB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTISENDJOB actions', async () => {
      const arg = 42666;
