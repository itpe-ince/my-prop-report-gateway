...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTISENDTARGET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTISENDTARGET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTISENDTARGET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTISENDTARGET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTISENDTARGET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTISENDTARGET actions', async () => {
      const arg = 42666;
