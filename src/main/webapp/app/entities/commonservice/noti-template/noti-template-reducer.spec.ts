...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTITEMPLATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTITEMPLATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTITEMPLATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTITEMPLATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTITEMPLATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTITEMPLATE actions', async () => {
      const arg = 42666;
