...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTACHFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ATTACHFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ATTACHFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ATTACHFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ATTACHFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ATTACHFILE actions', async () => {
      const arg = 42666;
