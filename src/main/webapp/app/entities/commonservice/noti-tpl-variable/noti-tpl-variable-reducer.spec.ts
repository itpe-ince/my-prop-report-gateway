...
import reducer, {
  ...
  reset,
  updateEntity,
} from './noti-tpl-variable.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTITPLVARIABLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTITPLVARIABLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTITPLVARIABLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTITPLVARIABLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTITPLVARIABLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTITPLVARIABLE actions', async () => {
      const arg = 42666;
