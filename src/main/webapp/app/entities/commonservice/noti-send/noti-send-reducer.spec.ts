...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './noti-send.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTISEND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTISEND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTISEND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTISEND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTISEND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTISEND actions', async () => {
      const arg = 42666;
