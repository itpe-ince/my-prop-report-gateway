...
export const UserInfoDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/user-info${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.userserviceUserInfo.delete.question">
        <Translate contentKey="gatewayApp.userserviceUserInfo.delete.question" interpolate={{ id: userInfoEntity.id }}>
