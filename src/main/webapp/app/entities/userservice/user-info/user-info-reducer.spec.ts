...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './user-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERINFO actions', async () => {
      const arg = 42666;
